...
var BaseChatModel = class BaseChatModel extends require_language_models_base.BaseLanguageModel {
	...
	*/
	async *_streamChatModelEvents(messages, options, runManager) {
		yield* require_language_models_compat.convertChunksToEvents(this._streamResponseChunks(messages, options, runManager), { signal: options.signal });
	}
	streamEvents(input, options, streamOptions) {
		...
		return new require_language_models_stream.ChatModelStream(this._streamChatModelEvents(messages, callOptions));
	}
	/**
