...
* ```
*/
var PromptTemplate = class PromptTemplate extends require_string.BaseStringPromptTemplate {
	static lc_name() {
	...
	*/
	...
	constructor(input) {
		...
		if (this.validateTemplate) {
			...
			require_template.checkValidTemplate(this.template, this.templateFormat, totalInputVariables);
		}
	}
	_getPromptType() {
		return "prompt";
	...
	*/
	async format(values) {
		...
		return require_template.renderTemplate(this.template, this.templateFormat, allValues);
	}
	/**
