...
export declare class Stream<Item> implements AsyncIterable<Item> {
    ...
    constructor(iterator: () => AsyncIterator<Item>, controller: AbortController, client?: Groq);
    static fromSSEResponse<Item>(response: Response, controller: AbortController, client?: Groq): Stream<Item>;
    /**
     * Generates a Stream from a newline-separated ReadableStream
     * where each item is a JSON value.
     */
    static fromReadableStream<Item>(readableStream: ReadableStream, controller: AbortController, client?: Groq): Stream<Item>;
