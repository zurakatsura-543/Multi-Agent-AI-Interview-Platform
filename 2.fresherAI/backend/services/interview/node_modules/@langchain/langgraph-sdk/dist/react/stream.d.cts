...
import { StateRecord } from "../ui/stream/base.cjs";
...
declare function useStream<T = Record<string, unknown>, Bag extends BagTemplate = BagTemplate>(options: UseStreamCustomOptions<StateRecord<InferStateType<T>>, InferBag<T, Bag>>): ResolveStreamInterface<T, InferBag<T, Bag>>;
//#endregion
export { useStream };
