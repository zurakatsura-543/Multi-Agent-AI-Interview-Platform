...
//#region src/client/stream/subscription.d.ts
/**
 ...
 */
declare function inferChannel(event: Event): Channel | undefined;
/**
 ...
 */
declare function matchesSubscription(event: Event, definition: SubscribeParams): boolean;
//#endregion
export { inferChannel, matchesSubscription };
