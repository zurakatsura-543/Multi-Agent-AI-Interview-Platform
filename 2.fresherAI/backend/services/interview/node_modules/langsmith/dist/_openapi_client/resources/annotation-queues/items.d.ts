...
import { ItemsCursorGetPagination, type ItemsCursorGetPaginationParams, PagePromise } from '../../core/pagination.js';
...
export declare class Items extends APIResource {
     ...
     * and project_id.
     */
    create(queueID: string, params: ItemCreateParams, options?: RequestOptions): APIPromise<ItemCreateResponse>;
    /**
     ...
     */
    list(queueID: string, query: ItemListParams, options?: RequestOptions): PagePromise<ItemListResponsesItemsCursorGetPagination, ItemListResponse>;
    /**
     ...
     */
    createStatus(queueItemID: string, body: ItemCreateStatusParams, options?: RequestOptions): APIPromise<ItemCreateStatusResponse>;
    /**
     * Remove RUN or THREAD items from a single annotation queue by item ID.
     */
    deleteAll(queueID: string, body: ItemDeleteAllParams, options?: RequestOptions): APIPromise<ItemDeleteAllResponse>;
    /**
     * Returns the number of annotation queue items for the requested reviewer-specific
     * or archived bucket.
     */
    retrieveCount(queueID: string, query: ItemRetrieveCountParams, options?: RequestOptions): APIPromise<ItemRetrieveCountResponse>;
    /**
     * Resolve a RUN or THREAD item to its current review section and zero-based
     * position for deep linking.
     */
    retrievePlacement(itemID: string, params: ItemRetrievePlacementParams, options?: RequestOptions): APIPromise<ItemRetrievePlacementResponse>;
}
...
export type ItemDeleteAllResponse = {
    [key: string]: string;
};
