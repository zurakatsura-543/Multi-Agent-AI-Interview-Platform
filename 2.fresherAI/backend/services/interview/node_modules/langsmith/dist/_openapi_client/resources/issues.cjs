...
class Issues extends resource_js_1.APIResource {
     ...
     */
    retrieve(id, options) {
        return this._client.get((0, path_js_1.path) `/api/v1/platform/issues/${id}`, options);
    }
    /**
     * **Beta:** This endpoint is in active development and may change without notice.
     *
     ...
     */
    list(query = {}, options) {
        return this._client.getAPIList('/api/v1/platform/issues', (pagination_js_1.OffsetPaginationIssues), {
            query,
            ...options,
        });
    }
