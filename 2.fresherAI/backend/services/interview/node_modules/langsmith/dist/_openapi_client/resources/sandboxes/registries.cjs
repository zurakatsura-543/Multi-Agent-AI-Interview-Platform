...
class Registries extends resource_js_1.APIResource {
    ...
    retrieve(name, options) {
        return this._client.get((0, path_js_1.path) `/api/v2/sandboxes/registries/${name}`, options);
    }
    /**
     * Update a sandbox registry's name and/or credentials.
     */
    update(name, body, options) {
        return this._client.patch((0, path_js_1.path) `/api/v2/sandboxes/registries/${name}`, { body, ...options });
    }
    /**
     ...
     */
    delete(name, options) {
        return this._client.delete((0, path_js_1.path) `/api/v2/sandboxes/registries/${name}`, {
            ...options,
