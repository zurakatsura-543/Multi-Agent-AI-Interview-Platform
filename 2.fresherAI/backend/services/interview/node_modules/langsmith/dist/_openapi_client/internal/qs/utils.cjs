...
function merge(target, source, options = {}) {
    ...
    if (typeof source !== 'object') {
        if ((0, values_js_1.isArray)(target)) {
            target.push(source);
        }
    ...
    if ((0, values_js_1.isArray)(target) && !(0, values_js_1.isArray)(source)) {
        // @ts-ignore
    ...
    for (let j = 0; j < string.length; j += limit) {
        ...
        for (let i = 0; i < segment.length; ++i) {
            ...
            if (c === 0x2d || // -
                ...
                (c >= 0x41 && c <= 0x5a) || // a-z
                (c >= 0x61 && c <= 0x7a) || // A-Z
                (format === formats_js_1.RFC1738 && (c === 0x28 || c === 0x29)) // ( )
            ) {
