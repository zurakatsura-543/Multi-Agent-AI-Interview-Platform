...
exports.evaluatorLogFeedbackPromises = exports.testWrapperAsyncLocalStorageInstance = exports.DEFAULT_TEST_CLIENT = void 0;
    ...
    if (trackingEnabled(context)) {
        ...
        exports.evaluatorLogFeedbackPromises.add((async () => {
            if (context.project == null) {
                throw new Error("Could not log feedback to LangSmith: missing project information. Please contact us for help.");
            }
