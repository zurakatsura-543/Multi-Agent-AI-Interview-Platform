...
exports.QueryBackend = void 0;
exports.getQueryBackend = getQueryBackend;
exports.v2RunToRun = v2RunToRun;
exports.loadTracesV2 = loadTracesV2;
exports.QueryBackend = {
...
function getQueryBackend(instanceFlags) {
    ...
    if (!chEnabled && sdbEnabled)
        return exports.QueryBackend.SMITHDB_ONLY;
    if (chEnabled && sdbEnabled)
        return exports.QueryBackend.DUAL;
    return exports.QueryBackend.CLICKHOUSE_ONLY;
}
