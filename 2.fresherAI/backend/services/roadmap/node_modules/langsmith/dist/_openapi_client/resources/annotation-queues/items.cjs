...
class Items extends resource_js_1.APIResource {
    /**
    ...
    create(queueID, params, options) {
        ...
        return this._client.post((0, path_js_1.path) `/api/v1/platform/annotation-queues/${queueID}/items`, {
    ...
    update(itemID, params, options) {
        ...
        return this._client.patch((0, path_js_1.path) `/api/v1/platform/annotation-queues/${queue_id}/items/${itemID}`, {
            body,
            ...options,
        });
    }
    ...
    list(queueID, query, options) {
        return this._client.getAPIList((0, path_js_1.path) `/api/v1/platform/annotation-queues/${queueID}/items`, (pagination_js_1.ItemsCursorGetPagination), { query, ...options });
    }
    /**
    ...
    createStatus(queueItemID, body, options) {
        return this._client.post((0, path_js_1.path) `/api/v1/platform/annotation-queues/items/${queueItemID}/status`, {
            body,
            ...options,
        });
    }
    ...
    deleteAll(queueID, body, options) {
        return this._client.post((0, path_js_1.path) `/api/v1/platform/annotation-queues/${queueID}/items/delete`, {
            body,
            ...options,
        });
    }
    ...
    retrieveCount(queueID, query, options) {
        return this._client.get((0, path_js_1.path) `/api/v1/platform/annotation-queues/${queueID}/items/count`, {
            query,
            ...options,
        });
    }
    ...
    retrievePlacement(itemID, params, options) {
        ...
        return this._client.get((0, path_js_1.path) `/api/v1/platform/annotation-queues/${queue_id}/items/${itemID}/placement`, options);
    }
}
exports.Items = Items;
