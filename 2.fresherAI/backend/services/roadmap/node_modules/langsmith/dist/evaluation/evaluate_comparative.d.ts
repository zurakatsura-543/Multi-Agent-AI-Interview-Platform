...
import { ComparativeExperiment, ComparisonEvaluationResult as ComparisonEvaluationResultRow, Example, Run, TracerSession } from "../schemas.js";
import { evaluate } from "./index.js";
type ExperimentResults = Awaited<ReturnType<typeof evaluate>>;
export declare function loadTracesForExperiment(client: Client, project: TracerSession, options: {
    loadNested: boolean;
}): Promise<Run[]>;
