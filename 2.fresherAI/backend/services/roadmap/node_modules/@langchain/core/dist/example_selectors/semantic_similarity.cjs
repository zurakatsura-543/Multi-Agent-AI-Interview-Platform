...
* ```
*/
var SemanticSimilarityExampleSelector = class SemanticSimilarityExampleSelector extends require_base.BaseExampleSelector {
	...
	*/
	async addExample(example) {
		...
		await this.vectorStoreRetriever.addDocuments([new require_document.Document({
