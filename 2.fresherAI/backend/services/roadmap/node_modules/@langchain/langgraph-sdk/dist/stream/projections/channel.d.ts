...
//#region src/stream/projections/channel.d.ts
interface ChannelProjectionOptions {
  /**
...
declare function channelProjection(channels: readonly Channel[], namespace: readonly string[], options?: ChannelProjectionOptions): ProjectionSpec<Event[]>;
//#endregion
export { ChannelProjectionOptions, channelProjection };
